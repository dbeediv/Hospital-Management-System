...
#for showing signup/login button for admin(by Divyabharathi)
...
#for showing signup/login button for doctor(by Divyabharathi)
...
#for showing signup/login button for patient(by Divyabharathi)
...
#-----------for checking user is doctor , patient or admin(by Divyabharathi)
def is_admin(user):
